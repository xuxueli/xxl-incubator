...
<body class="hold-transition skin-blue sidebar-mini <#if cookieMap?exists && "off" == cookieMap["adminlte_settings"].value >sidebar-collapse</#if> ">
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <div class="input-group">
                            <span class="input-group-addon">BIZ-ID</span>
                            <select class="form-control" id="nodeGroup" >
								<#list XxlPushBiz as biz>
									<option value="${biz}" >${biz.title}</option>
								</#list>
                            </select>
                        </div>
                    </div>
                    <div class="col-xs-4">
                        <div class="input-group">
                            <span class="input-group-addon">CONN-ID</span>
                    ...
                    <div class="col-xs-2">
                        <button class="btn btn-block btn-success" id="add" type="button">推送消息</button>
                    </div>
                </div>
    ...
    <script src="${request.contextPath}/static/js/channel.index.js"></script>

<#macro commonStyle>
	...
	<!-- pace -->
	<link rel="stylesheet" href="${request.contextPath}/static/adminlte/plugins/pace/pace.min.css">
...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			...
			<span class="logo-lg"><b>消息推送中心</b></span>
		</a>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click" ><a href="${request.contextPath}/channel"><i class="fa fa-circle-o text-red"></i> <span>连接管理</span></a></li>
...
<#macro commonFooter >
	<footer class="main-footer">
		...
		<strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
			<a href="https://github.com/xuxueli/xxl-push" target="_blank" >github</a>&nbsp;

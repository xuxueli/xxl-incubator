...
-- ----------------------------
-- 一级菜单
insert into sys_menu values('5', '首页', '0', '0', '/dashboard',      '', '', '', 1, 0, 'C', '0', '0', '', 'dashboard',   'admin', sysdate(), '', null, '首页');
...
insert into sys_menu values('4', '帮助中心', '0', '4', '/help', '', '', '', 1, 0, 'C', '0', '0', '', 'guide',    'admin', sysdate(), '', null, '帮助中心');
-- 二级菜单

 ...
 */
public class Draw2 extends ReceiverAdapter implements ActionListener, ChannelListener {
    ...
    public Draw2(String props, boolean no_channel, boolean jmx, boolean use_state, long state_timeout,
    ...
    public Draw2(JChannel channel) throws Exception {
    ...
    public Draw2(JChannel channel, boolean use_state, long state_timeout) throws Exception {
        this.channel=channel;
        channel.setReceiver(this);
        channel.addChannelListener(this);
        this.use_state=use_state;
    ...
    public static void main(String[] args) {
        ...
        try {
            draw=new Draw2("tcp-7801.xml", no_channel, jmx, use_state, state_timeout, use_unicasts, name,

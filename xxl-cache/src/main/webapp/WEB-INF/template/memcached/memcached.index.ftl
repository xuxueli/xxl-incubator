	    	...
	    	<div class="row">
                <div class="col-xs-4">
                    <div class="input-group">
                        <span class="input-group-addon">缓存Key</span>
                        <input type="text" class="form-control" id="executorHandler" value="${key}" autocomplete="on" >
                    </div>
                </div>
	            <div class="col-xs-2">
	            ...
	            <div class="col-xs-2">
	            	<button class="btn btn-block btn-success add" type="button">+缓存Key</button>
	            </div>
          	</div>
			            ...
			            <div class="box-body">
			              	<table id="job_list" class="table table-bordered table-striped">
				                <thead>
					            	<tr>
					            		<th name="id" >id</th>
					                	<th name="key" >缓存Key</th>
                                        <th name="value" >缓存Key</th>
					                  	<th>操作</th>
					                </tr>
				                </thead>
				                <tbody></tbody>

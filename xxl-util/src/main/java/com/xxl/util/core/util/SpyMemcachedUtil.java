 ...
 *  </dependency>
 *
 * # for spymemcached  (spymemcached.address="host01:port,host02:port")
 * spymemcached.address=192.168.56.101:11211
 *
 */
public class SpyMemcachedUtil {
    private static Logger logger = LoggerFactory.getLogger(SpyMemcachedUtil.class);
